/* testuv - tests PECUV conversion routines */
...
void cuvdo(char*,int,char*,LONG); 
FILE far *openDM(char*);	/* OK, since opens .SP file */
...
/********************************* CUVDO *********************/
	cuvdo(fname,sphandle,inalloc,spilength);

	errstrg("testuv complete \n");
	}
