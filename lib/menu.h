...
#define ITEM(s,k,h,act,arg) {s, MenuITEM, k, h, act, (void *)(arg)},
#define EXIT(s,k,h,act,arg) {s, MenuEXIT, k, h, act, (void *)(arg)},
#define RETN(s,k,h,act,arg) {s, MenuRETN, k, h, act, (void *)(arg)},
#define DFLT(act) 			{0, MenuDFLT, 0, 0, act, (void *)0},
#define CTRL(act)		 	{0, MenuCTRL, 0, 0, act, (void *)0},
...
#define TOP_(s,k,h)			{s, MenuITEM, k, h, MenuTop, (void*)0},
#define RTTO(s,k,h,m)		{s, MenuITEM, k, h, MenuRtnTo, &m->selector},
#define  POP(s,k,h)			{s, MenuITEM, k, h, MenuPop,  (void *)0},

#define DATA(s,k,h,d)		{s, MenuITEM, k, h, MenuData, (void *)&d},
#define STR(s,k,h,d)		{s, MenuITEM, k, h, MenuString, (void *)&d},
#define SHRT(s,k,h,d)		{s, MenuITEM, k, h, MenuShort, (void *)&d},
#define LONG(s,k,h,d)		{s, MenuITEM, k, h, MenuLong, (void *)&d},
#define FLOT(s,k,h,d)		{s, MenuITEM, k, h, MenuFloat, (void *)&d},
#define DOUB(s,k,h,d)		{s, MenuITEM, k, h, MenuDouble, (void *)&d},

#define LINK(m)				{0, MenuLINK, 0, 0, 0, &m->selector},
#define DSCR(m)				{0, MenuDSCR, 0, 0, 0, &m.keywordSelect},
#define HEAD(s,k,h,act,arg)	{s, MenuHEAD, k, h, act, (void *)(arg)},
